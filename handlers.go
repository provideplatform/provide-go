...
func CORSMiddleware() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		c.Writer.Header().Set("Access-Control-Allow-Headers", "Accept, Accept-Encoding, Authorization, Cache-Control, Content-Length, Content-Type, Origin, User-Agent, X-CSRF-Token, X-Requested-With, X-Total-Results-Count")
